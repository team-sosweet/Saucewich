...
void ASaucewichPlayerController::PrintMessageLocal(const FText& Message, const float Duration, const EMsgType Type) const
{
...
{
	PrintMessageLocal(Message, Duration, Type);
}
